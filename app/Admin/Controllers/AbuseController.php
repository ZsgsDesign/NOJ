...
class AbuseController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->saving(function(Form $form) {
            ...
            switch ($abuse->category) {
                case 0:
                    $this->processGroupAbuse($abuse, $subject_id, $form->audit);
                    break;
                case 1:
                    $this->processUserAbuse($abuse, $subject_id);
                    break;
                default:
                    break;
            }
    ...
    public function processGroupAbuse($abuse, $subject_id, $audit)
    {
        $gid=$subject_id;
    ...
    public function processUserAbuse($abuse, $subject_id)
    {
        $ban_time=request()->created_at;
        UserBanned::create([
            'abuse_id'   => $abuse->id,
