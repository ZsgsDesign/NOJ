...
class Curl
{
    ...
    protected function grab_page($site, $oj, $headers=[])
    {
        $ch=curl_init();
    ...
    protected function post_data($site, $data, $oj, $ret=false, $follow=true, $returnHeader=true, $postJson=false, $extraHeaders=[])
    {
        $datapost=curl_init();
        $headers=array("Expect:");
        if ($postJson) {
