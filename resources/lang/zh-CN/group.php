...
return [
    ...
    'detail' => [
        ...
        'contestTitle' => "{$contestLocale}标题",
        'contestBeginTime' => "{$contestLocale}开始时间",
        'myProfile' => '我的资料',
        'edit' => '编辑',
        'nickname' => '昵称',
        'none' => '无',
    ...
    'analysis' => [
        ...
        'contestName' => "{$contestLocale}名",
        'afterContestElo' => "{$contestLocale}结束后Elo分值",
        'close' => '关闭',
        'tagRader' => '标签雷达',
        'chartLabelElo' => 'Elo分值',
    ...
    'common' => [
        ...
        'contestManagement' => "{$contestLocale}管理",
    ...
    'contest' =>[
        'arrangeContest' => "发布{$contestLocale}" ,
        'arrange' => '发布',
        'successArrange' => "{$contestLocale}发布成功，是否跳转到{$contestLocale}页面?",
        'jumpTo' => '跳转',
        'return' => '返回',
        'assignee' => '负责人',
        'contestName' => "{$contestLocale}名",
        'contestBeginTime' => "{$contestLocale}开始时间",
        'contestEndTime' => "{$contestLocale}结束时间",
        'publicContest' => "公开{$contestLocale}",
        'practiceContest' => '训练赛',
        ...
        'opr' => '操作',
        'addProblem' => '添加题目',
        'description' => "{$contestLocale}简介",
        'update' => '更新',
        'assignMember' => "指定{$contestLocale}负责人",
        'cancel' => '取消',
        'problemCode' => '题号',
        'close' => '关闭',
        'add' => '添加',
        'errorContestTimeShort' => "{$contestLocale}时间起码1分钟。",
        'noChargeContest' => "您没有负责任何{$contestLocale}。",
        'noContestInGroup' => "本群组尚未创建{$contestLocale}。",
        'noOneAssigned' => "本{$contestLocale}没有指定负责人，点击以指定。",
        'deleteProblemTip' => '删除这个题目',
        'errorProblemNonExist' => '题目不存在',
        'errorLoading' => "正在加载{$contestLocale}信息，慢点",
        'errorEmptyName' => "{$contestLocale}名不能为空",
        'errorEmptyBeginTime' => "{$contestLocale}开始时间不能为空",
        'errorEmptyEndTime' => "{$contestLocale}结束时间不能为空",
    ],
    'problem' => [
        'title' => '群组题目管理',
        'empty' => '没有您可以操作的题目',
