            ...
            $.ajax({
                ...
                headers: {
                    ...
                    if(result.ret == '200' && result.data.length != 0){
                        $("#message-tip").attr('title','@lang('noj.nav.message.tip_head')' + result.data.length + '@lang('noj.nav.message.tip_foot')');
                        ...
                        $("#message-tip").attr('title','@lang('noj.nav.message.empty')');
                        $("#message-tip").tooltip('dispose');
                        $("#message-tip").tooltip();
                    }
                    console.log(result);
