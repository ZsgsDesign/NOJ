...
**1.1**  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (**you**), and **{{config('term.subject.fullName')}}**, doing business as **{{config('term.subject.name')}}**, located at **{{config('term.street')}}, {{config('term.city')}}, {{config('term.province')}}, {{config('term.state')}} {{config('term.zip')}}**, concerning your access to and use of the **{{config('app.displayName')}} ({{config('app.name')}})** website as well as any related applications (the **Site**).

The Site provides the following services: **Online Judge, Virtual Judge involved third-party providers known as Babel Extension, contests, groups and social discussions (services)**. You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.

**If you do not agree with all of these Terms and Conditions, then you are prohibited from using the Site and Services and you must discontinue use immediately**. We recommend that you print a copy of these Terms and Conditions for future reference.

**1.2**  The supplemental policies set out below, as well as any supplemental terms and condition or documents that may be posted on the Site from time to time, are expressly incorporated by reference.
...
If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at {{config('term.contact.email')}}.
...
**4.2**  _You further agree that we can use your User Content for any other purposes whatsoever in perpetuity without payment to you, and combine your User Content with other content for use within the Site and otherwise. We do not have to attribute your User Content to you_.
...
**4.7**  If you wish to complain about User Content uploaded by other users please contact us at {{config('term.contact.email')}} or use the take down or report button.
...
**11.8**  **_For consumers only_**- _Please note that these Terms and Conditions, their subject matter and their formation, are governed by Chinese law._

**11.9**  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at {{config('term.contact.email')}}.

------

{{config('term.subject.fullName')}}<br>
{{config('term.street')}}<br>
{{config('term.city')}}, {{config('term.province')}}, {{config('term.zip')}}<br>
{{config('term.state')}}
