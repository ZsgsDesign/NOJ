                    ...
                    <contest-card class="animated fadeInLeft" style="animation-delay: {{$loop->index/5}}s;">
                        ...
                        <info-div>
                            <h5 class="sm-contest-title">
                                @if($c['desktop'])<span><i class="MDI lan-connect wemd-pink-text" data-toggle="tooltip" data-placement="left" title="NOJ Desktop"></i></span>@endif
                ...
                <p class="cm-trending"><i class="MDI star wemd-amber-text"></i> Featured Contest</p>
                    <paper-card style="text-align:center;">
                        @if(!is_null($featured))
                            ...
                            <h5>
                                @if($featured['desktop'])<span><i class="MDI lan-connect wemd-pink-text" data-toggle="tooltip" data-placement="left" title="NOJ Desktop"></i></span>@endif
