                    ...
                    <div class="tab-pane fade show active" id="relative" role="tabpanel" aria-labelledby="relative-tab">
                        <div class="form-group">
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="MDI code-not-equal-variant"></i> BBCode</div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="MDI language-html"></i> HTML</div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="MDI markdown"></i> Markdown</div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="MDI link-variant"></i> Image URL</div>
                                </div>
