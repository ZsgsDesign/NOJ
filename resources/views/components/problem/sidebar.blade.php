...
<paper-card class="animated fadeInRight">
    ...
    <div>
        ...
        <p><span>{{__("problem.info.submitted")}} </span> <span class="wemd-black-text"> {{$statistics['submission_count']}}</span></p>
        <p><span>{{__("problem.info.passed")}} </span> <span class="wemd-black-text"> {{$statistics['passed_count']}}</span></p>
        <p><span>{{__("problem.info.acrate")}} </span> <span class="wemd-black-text"> {{round($statistics['ac_rate'], 2)}}%</span></p>
